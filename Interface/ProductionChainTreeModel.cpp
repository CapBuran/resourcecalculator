...
public:
  ...
  ProductionChainTreeItem* parentItem() { return const_cast<ProductionChainTreeItem*>(_m_parentItem); }
  ProductionChainTreeItem* child(int row) { return _m_childItems.value(row); }
  int childCount()
  {
    Init(_m_childItems);
