#include "IconDispatcherDialog.h"
...
IconDispatcherDialog::IconDispatcherDialog(const ResourceCalculator::ParamsCollection &PC, QWidget *parent)
...
const ResourceCalculator::Icon * IconDispatcherDialog::GetResult() const
{
